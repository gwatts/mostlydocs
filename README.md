...
To use this for yourself, make a copy of this template project and change `content/en` as needed (don't forget to run `git submodule init --recursive` to fetch the theme and its dependencies).
